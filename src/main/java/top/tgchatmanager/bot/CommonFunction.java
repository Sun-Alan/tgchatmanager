...
import top.tgchatmanager.callBack.deleteRuleCallBack.DeleteSingleRuleByKeyWord;
import top.tgchatmanager.callBack.replyRuleCallBack.AddAutoReplyRule;
...
import top.tgchatmanager.handleService.*;
...
import top.tgchatmanager.utils.aiMessageCheck.AiCheckMedia;
import top.tgchatmanager.utils.aiMessageCheck.AiCheckMessage;
import top.tgchatmanager.utils.groupCaptch.*;
...
import top.tgchatmanager.wordCloud.MessageService;
            ...
            try {
                ...
                if (update.hasMessage() && update.getMessage().getText() != null && update.getMessage().getChat().isUserChat()) {
                    ...
                    if (update.getMessage().getText().contains("start _groupId")) {
                        ...
                        keywordsFormat.setReplyText("<b>GitHub地址：</b><b><a href='https://github.com/Sun-Alan/tgchatmanager'>点击查看</a></b>\n<b>官方群组：</b>");
